...
## Quick Docker Start
  ...
  ```bash
    ...
    django-admin startproject --template=https://github.com/GeoNuxt/geonode-project/archive/refs/heads/4.3.x.zip -e py,sh,md,rst,json,yml,ini,env,sample,properties -n monitoring-cron -n Dockerfile project_name ~/project_name
